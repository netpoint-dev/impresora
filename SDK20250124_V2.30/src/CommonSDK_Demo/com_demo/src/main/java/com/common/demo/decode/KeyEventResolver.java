...
public class KeyEventResolver {
    ...
    private final static long MESSAGE_DELAY = 500;//延迟50ms，判断扫码是否完成。
    ...
    public void setOnKeyEventListener(OnKeyEventListener onScanSuccessListener) {
        mOnKeyEventListener = onScanSuccessListener;
    }
